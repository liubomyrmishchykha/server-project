...
namespace WcfServiceLibrary
{
    ...
    public class CorsEnablingMessageInspector : IDispatchMessageInspector
    {
        ...
        public void BeforeSendReply(ref Message reply, object correlationState)
        {
            ...
            response.Headers.Add("Access-Control-Allow-Origin", CorsDomain.Name);
            response.Headers.Add("Access-Control-Allow-Methods", CorsDomain.AllowMethods);
            response.Headers.Add("Access-Control-Allow-Headers", CorsDomain.AllowHeaders);
        }
    }
    ...
    public class EnableCorsSupportBehaviorElement : BehaviorExtensionElement
    {
        ...
        public override Type BehaviorType { get { return typeof(EnableCorsSupportBehavior); } }
