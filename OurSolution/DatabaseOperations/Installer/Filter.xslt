...
xmlns:wix="http://schemas.microsoft.com/wix/2006/wi">
  ...
  <xsl:key name="service-search" match="wix:Component[wix:File/@Source = '$(var.WindowsService.TargetDir)\WindowsService.exe']" use="@Id" />
  <xsl:key name="service-search" match="wix:Component[wix:File/@Source = '$(var.WCFWindowsServiceHosting.TargetDir)\WCFWindowsServiceHosting.exe']" use="@Id" />
